...
const (
	...
	ReportService_GetTimeSeriesData_FullMethodName = "/report.ReportService/GetTimeSeriesData"
)
...
func (c *reportServiceClient) GetTimeSeriesData(ctx context.Context, in *TimeSeriesRequest, opts ...grpc.CallOption) (*TimeSeriesResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(TimeSeriesResponse)
	err := c.cc.Invoke(ctx, ReportService_GetTimeSeriesData_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedReportServiceServer) GetTimeSeriesData(context.Context, *TimeSeriesRequest) (*TimeSeriesResponse, error) {
...
func _ReportService_GetTimeSeriesData_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TimeSeriesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReportServiceServer).GetTimeSeriesData(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReportService_GetTimeSeriesData_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReportServiceServer).GetTimeSeriesData(ctx, req.(*TimeSeriesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReportService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ReportService_GetTimeSeriesData_Handler,
		},
	},
